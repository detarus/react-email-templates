            ...
            <Section className="px-6 pb-8">
              ...
              <div style={{ marginBottom: '32px' }}>
                <Text style={{
                  ...
                  <a href="https://flowtune.pro" style={{ color: '#FEFEFE' }}>Flowtune.pro</a> - это в первую очередь, это эфффективный отдел контроля качества, который помогает вашей команде по конкретным метрикам.
                </Text>
              </div>
