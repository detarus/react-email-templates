            ...
            <Section className="mb-8" style={{
              ...
              <div style={{ padding: '24px 24px', textAlign: 'center' }}>
                <Heading style={{
                  ...
                  Увеличьте продажи недвижимости на 7-15% с помощью AI-анализа звонков
                </Heading>
                <Text style={{
                  color: '#FEFEFE',
                  fontSize: '16px',
                  ...
                  Агентная система автоматического анализа и оптимизации переговоров вашей команды
                </Text>
              </div>
            </Section>
            ...
            <Section className="px-6 pb-8">
              ...
              <div style={{ marginBottom: '32px' }}>
                <Text style={{
                  ...
                  <a href="https://flowtune.pro" style={{ color: '#FEFEFE' }}>Flowtune.pro</a> - автоматизированная система контроля качества для агентств недвижимости. Каждый звонок вашего агента — это потенциальная сделка. Flowtune помогает вашим специалистам закрывать больше сделок, работать по скриптам и быстро обучать новых сотрудников.
                </Text>
              </div>
              ...
              <div style={{ marginBottom: '32px' }}>
                <Heading style={{
                  ...
                  Что делает Flowtune особенно полезным?
                </Heading>
                ...
                <ul style={{ 
                  ...
                  <li style={{ 
                    ...
                    Показывает, где агент теряет клиента — упущенные этапы, неуверенная работа с возражениями, отклонения от скрипта
                  </li>
                  <li style={{ 
                    marginBottom: '12px',
                    fontSize: '16px',
                    ...
                    Сокращает адаптацию новых риэлторов — за счёт прозрачной обратной связи и трекинга прогресса
                  </li>
                  <li style={{ 
                    marginBottom: '12px',
                    fontSize: '16px',
              ...
              <div style={{ marginBottom: '32px' }}>
                <Heading style={{
                  ...
                  Результаты наших клиентов в недвижимости:
                </Heading>
                    ...
                    <td style={{ paddingBottom: '16px' }}>
                      <div style={{ backgroundColor: '#1E3A8A', padding: '24px', borderRadius: '12px' }}>
                        ...
                        <Text style={{
                          ...
                          lineHeight: '20px',
                          margin: '0'
                        }}>сокращение времени на адаптацию новых агентов</Text>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div style={{ backgroundColor: '#581C87', padding: '24px', borderRadius: '12px' }}>
                        ...
                        <Text style={{
                          ...
                          lineHeight: '20px',
                          margin: '0'
                        }}>увеличение среднего чека за счёт грамотной презентации объектов
                        </Text>
                      </div>
                    </td>
                  </tr>
